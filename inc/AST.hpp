...
class CallExprAST : public BaseAST {
    ...
    static inline bool classof(BaseAST const* base){return base->getValueID() == CallExprID;}
};
...
class NumberAST : public BaseAST {
    ...
    static inline bool classof(BaseAST const* base){return base->getValueID() == NumberID;}
};
